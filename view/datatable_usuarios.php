                  ...
                  <!-- table-bordered -->
                   <div class="table-responsive">
                    ...
                    <thead   style="text-align:center;">
                      ...
                      <th style="font-size:12px; width: 8px;">ITEM</th>
                      <th style="font-size:12px; width: 22px;">DATOS</th>
                      
                      <th style="font-size:12px; width: 12px;">DEPENDENCIA</th>
                      <th style="font-size:12px; width: 13px;">PERFIL</th>
                      <th style="font-size:12px; width:;">USUARIO</th>
                      <th style="font-size:12px; width:;">CONTRASEÑA</th>
                      <th style="font-size:12px; width:;">FECHA_REG</th>
                      
                      
                      <th style="font-size:12px; width: 8px;">ESTADO</th> 				  
                      <th style="font-size:12px; width: 15px;">CONTROL</th> 	
                    </thead>
                        <tbody >
                    ...
                    <tr>
                       ...
                       <td style="font-size:12px; width:20px;"><?php echo $key['EMP_APELLIDOS'].' '.$key['EMP_NOMBRES'];;?></td>
